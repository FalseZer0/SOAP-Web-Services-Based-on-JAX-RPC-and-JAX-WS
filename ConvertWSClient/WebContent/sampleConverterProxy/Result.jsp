...
<jsp:useBean id="sampleConverterProxyid" scope="session" class="DefaultNamespace.ConverterProxy" />
<%
...
case 10:
        gotMethod = true;
        DefaultNamespace.Converter getConverter10mtemp = sampleConverterProxyid.getConverter();
