 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://calculator/", wsdlLocation = "http://localhost:8080/ExampleJAX-WS/calculate?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/ExampleJAX-WS/calculate?wsdl");
     ...
     * 
     * @return
     *     returns CalculatorInterface
     */
    @WebEndpoint(name = "CalculatorImplPort")
    public CalculatorInterface getCalculatorImplPort() {
        return super.getPort(new QName("http://calculator/", "CalculatorImplPort"), CalculatorInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "CalculatorImplPort")
    public CalculatorInterface getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculator/", "CalculatorImplPort"), CalculatorInterface.class, features);
    }
